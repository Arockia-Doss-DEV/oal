...
<body>
    ...
    <table>
        <tbody align="center">
            ...
            <tr>
            	<td>
            		<img src="data:image/png;base64, <?php echo e(base64_encode(@file_get_contents(public_path('mauri-logo.png')))); ?>" width="150px;" height="90px">
            	</td>
            </tr>
	...
	<table width="100%" class="number-table">
		<tbody>
			<tr>
				<td width="5%" class="font-15"><input type="checkbox" <?php echo e(($subscription->ja_peb_declaration_status == 1) ? "checked" : ''); ?> /></td>
				<td  class=" font-15">No  </td>
			</tr>
			<tr>
				<td width="5%" class="font-15"><input type="checkbox" <?php echo e(($subscription->ja_peb_declaration_status == 2) ? "checked" : ''); ?> /></td>
	...
	<?php if($subscription->peb_declaration_status == 1): ?>
	...
	<?php elseif($subscription->peb_declaration_status == 2): ?>
		...
		<?php
	        $joint_origin_fund_wealth = explode(', ', $subscription->ja_origin_fund_wealth);
	    ?>

		<table width="100%" class="number-table">
			<tbody>

				<?php $__currentLoopData = $joint_origin_fund_wealth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $origin_fund_wealth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					
					<tr>
						<td width="5%" class="mr-1"><input type="checkbox" checked /></td>
						<td  class="font-15"><?php echo e($origin_fund_wealth); ?></td>
					</tr>
		...
		<?php if( !empty($subscription->ja_origin_fund_wealth_other) &&  in_array('Other', $joint_origin_fund_wealth) ){ ?> 

		<br>
		<table width="100%" class="number-table">
			<tbody>
				<tr>
					<td class="font-15"><u class="dotted"> <?php echo e($subscription->ja_origin_fund_wealth_other); ?> </u></td>
				</tr>
			</tbody>
		</table>
...
</html><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/pdf/jointPEPDeclarationPdf.blade.php ENDPATH**/ ?>