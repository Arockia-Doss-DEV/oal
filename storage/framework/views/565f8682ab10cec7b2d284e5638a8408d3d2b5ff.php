<?php $__env->startSection('scripts'); ?>
	<script>
		$(document).ready(function() {
			...
			var form = $("#additionalSubscriptionForm");
	        form.children("div").steps({
	            ...
	            onStepChanging: function (event, currentIndex, newIndex){
	                ...
	                if (newIndex > currentIndex){
	                	...
	                	if (false === $('#additionalSubscriptionForm').parsley().validate('block' + currentBlock)){
		                    return false;
		                }
		            }else{
		            	return true;
        ...
        function saveScubscriptionDraft(){
        	...
        	preloader_init();
            const form = document.getElementById('additionalSubscriptionForm');
        ...
        function saveScubscription(){
        	if ($('#additionalSubscriptionForm').parsley().validate()) {
	            ...
	            axios.post(SITE_URL+'investor/subscriptionSave',formData,{
                    ...
                    if(item === "success"){
                    	...
                    	Swal.fire('Success', 'Additional Investment Created Successfully', 'success');
        ...
        function saveAdditionalSubscriptiontoDraft() {
        ...
        $('.saveAdditionalSubscription').click(function() {
...
<?php $__env->stopSection(); ?><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/investor/elements/additionalSubscriptionScript.blade.php ENDPATH**/ ?>