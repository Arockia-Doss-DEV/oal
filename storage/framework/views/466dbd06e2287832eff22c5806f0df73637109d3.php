				...
				<div class="row">
					<div class="col-lg-12 col-md-12 ">
						...
						<div class="card card-margin">
							...
							<div class="card-body">
							 	<?php echo Form::model($settings, array('url' => ['master'], 'method'=>'POST', 'files' => true, 'id' => 'user-form', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off" )); ?>
							 		...
							 		<div class="row col-md-12">
						 				...
						 				<div class="col-md-2">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('site_short_name', null, ['class' => 'form-control', 'id' => 'site_short_name', 'required'=> 'required']); ?>
									...
									<div class="row col-md-12">
							 			<div class="col-md-6">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('recipient_name', null, ['class' => 'form-control', 'id' => 'recipient_name', 'required'=> 'required']); ?>
		                                ...
		                                <div class="col-md-6">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('recipient_address', null, ['class' => 'form-control', 'id' => 'recipient_address', 'required'=> 'required']); ?>
							 		...
							 		<div class="row col-md-12">
							 			<div class="col-md-6">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('recipient_account_no', null, ['class' => 'form-control', 'id' => 'recipient_account_no', 'required'=> 'required']); ?>
		                                ...
		                                <div class="col-md-6">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('recipient_contact_no', null, ['class' => 'form-control', 'id' => 'recipient_contact_no', 'required'=> 'required']); ?>
							 		...
							 		<div class="row col-md-12">
							 			<div class="col-md-6">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('beneficiary_bank', null, ['class' => 'form-control', 'id' => 'beneficiary_bank', 'required'=> 'required']); ?>
		                                ...
		                                <div class="col-md-6">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('beneficiary_bank_address', null, ['class' => 'form-control', 'id' => 'beneficiary_bank_address', 'required'=> 'required']); ?>
							 		...
							 		<div class="row col-md-12">
							 			<div class="col-md-3">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('beneficiary_swift_code', null, ['class' => 'form-control', 'id' => 'beneficiary_swift_code', 'required'=> 'required']); ?>
		                                ...
		                                <div class="col-md-3">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('bank_code', null, ['class' => 'form-control', 'id' => 'bank_code', 'required'=> 'required']); ?>
		                                ...
		                                <div class="col-md-3">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('branch_code', null, ['class' => 'form-control', 'id' => 'branch_code', 'required'=> 'required']); ?>
							 		...
							 		<div class="row col-md-12">
		                                ...
		                                <div class="col-md-3">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('contact_enquiry_email', null, ['class' =>'form-control', 'id'=>'contact_enquiry_email', 'required'=>'required']); ?>
		                                ...
		                                <div class="col-md-3">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('subcription_fee_class_a', null, ['class' =>'form-control', 'id'=>'subcription_fee_class_a', 'required'=>'required','data-parsley-type'=>"digits"]); ?>
		                                ...
		                                <div class="col-md-3">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('subcription_fee_class_b', null, ['class' =>'form-control', 'id'=>'subcription_fee_class_b', 'required'=>'required','data-parsley-type'=>"digits"]); ?>
							 		...
							 		<div class="row col-md-12">
							 			...
							 			<div class="col-md-3">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('single_escrow_charge_initial', null, ['class' => 'form-control', 'id' => 'single_escrow_charge_initial', 'required'=> 'required']); ?>
		                                ...
		                                <div class="col-md-3">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('single_escrow_charge_additional', null, ['class' => 'form-control', 'id' => 'single_escrow_charge_additional', 'required'=> 'required']); ?>
										...
										<div class="col-md-3">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('joint_escrow_charge_initial', null, ['class' => 'form-control', 'id' => 'joint_escrow_charge_initial', 'required'=> 'required']); ?>
		                                ...
		                                <div class="col-md-3">
		                                    <div class="form-group">
			                                    ...
			                                    <?php echo Form::text('joint_escrow_charge_additional', null, ['class' => 'form-control', 'id' => 'joint_escrow_charge_additional', 'required'=> 'required']); ?>
							 		...
							 		<div class="row col-md-12">
							 			...
							 			<div class="col-md-3">
		                                    <div class="form-group">
		                                        ...
		                                        <div class="mt-2 string-check string-check-soft-info mb-2">
			                                        <input type="radio" name="sms_sent" value="1" <?php echo e($settings->sms_sent == 1 ? 'checked' : ''); ?>>
			                                    ...
			                                    <div class="mt-2 string-check string-check-soft-info mb-2">
			                                        <input type="radio" name="sms_sent" value="0" <?php echo e($settings->sms_sent == 0 ? 'checked' : ''); ?>>
			                                        <label class="string-check-label"> 
		                                ...
		                                <div class="col-md-3">
		                                    <div class="form-group">
												...
												<div class="mt-2 string-check string-check-soft-info mb-2">
			                                        <input type="radio" name="email_sent" value="1" <?php echo e($settings->email_sent == 1 ? 'checked' : ''); ?>>
			                                        <label class="string-check-label"> 
			                                            <span class="ml-2"> Enable </span> 
			                                        </label>
			                                    </div>
			                                    ...
			                                    <div class="mt-2 string-check string-check-soft-info mb-2">
			                                        <input type="radio" name="email_sent" value="0" <?php echo e($settings->email_sent == 0 ? 'checked' : ''); ?>>
			                                        <label class="string-check-label"> 
			                                            <span class="ml-2"> Disable </span> 
			                                        </label>
			                                    </div>
		...
		<div class="modal fade" id="changepasswordDataButton" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<?php echo Form::open(['url' => '/changePassword', 'files' => true, 'id' => 'password-form', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off" ]); ?>
		...
		<div class="modal fade" id="enable2FADataButton" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
				<div class="modal-content">
					...
					<?php echo Form::open(['url' => '/investor/enable2Fa', 'files' => true, 'id' => 'enable2FADataForm', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off" ]); ?>
											...
											<div class="kt-portlet__body">
												<div class="kt-widget kt-widget--general-1">
													<div class="kt-media kt-media--lg kt-media--circle">
														<img src="<?php echo e(asset('/admin/images/sample_image/googleauthenticator.png')); ?>" alt="image" style="max-width: 213px; height: 135px;">
													</div>
