<?php $__env->startSection('title', 'Create Investor'); ?>
                ...
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <h4 class="card_title">User Registration</h4>
                                </div>
                                <div class="col-md-2">
                        ...
                        <?php echo Form::open(array('route' => 'users.store', 'method'=>'POST', 'files' => true, 'id' => 'user-form', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off" )); ?>
                                ...
                                <div class="row col-md-12">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::select('roles', $roles, old('roles'), ['placeholder' => 'Please select user role ...', 'class' => 'form-control user-role', 'id'=>'roles', 'required' =>'required']); ?>

                                        </div>
                                    </div>

                                    <div class="col-lg-3 col-md-6 col-sm-12 salutation-col">
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" required  oninput="this.value = this.value.toUpperCase()" autofocus placeholder="Name">
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" placeholder="Email" required data-parsley-group="block1" data-parsley-checkemail data-parsley-checkemail-message="Email Address already Exists" data-parsley-trigger="focusout">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Phone Number" data-parsley-type="digits" value="<?php echo e(old('mobile_no')); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="address_line1" name="address_line1"  placeholder="Address  Line1" value="<?php echo e(old('address_line1')); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="city" name="city"  placeholder="City" value="<?php echo e(old('city')); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1">Country</label>
                                            <?php echo Form::select('country', $countries, null, ['class' => 'form-control', 'id'=>'country_id', 'required']); ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="postcode" name="post_code" placeholder="Post Code" value="<?php echo e(old('post_code')); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
     ...
     <script type="text/javascript">
        ...
        $(document).on('change', '.user-role', function() {
            ...
            if (this.value == 'Company') { 
                $(".salutation-col").hide();
                $("#salutation").removeAttr("required");

            } else {
                $(".salutation-col").show();
                $("#salutation").attr("required", "required");
            }
        });
