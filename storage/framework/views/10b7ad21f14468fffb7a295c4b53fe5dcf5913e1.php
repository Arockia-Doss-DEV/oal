<?php $__env->startSection('scripts'); ?>
	<script>
        ...
        function saveScubscriptionDraft(){
            ...
            axios.post(SITE_URL+'subscriptionEditSaveDraft',formData,{
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'X-CSRF-Token': csrfToken}}
            ).then(function(response){
        ...
        function saveScubscription(){
        	if ($('#additionalSubscriptionForm').parsley().validate()) {
	            ...
	            axios.post(SITE_URL+'subscriptionEditSave',formData,{
	                    headers: {
	                        'Content-Type': 'multipart/form-data',
	                        'X-CSRF-Token': csrfToken}}
	            ).then(function(response){
                    ...
                    if(item === "success"){
                        ...
                        Swal.fire('Great Job !','User subcription was updated successfully !!!','success');
                    }else{
...
<?php $__env->stopSection(); ?><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/admin/elements/editAdditionalSubscriptionScript.blade.php ENDPATH**/ ?>