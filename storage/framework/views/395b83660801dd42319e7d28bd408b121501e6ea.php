<?php $__env->startSection('title', 'Pending Funding'); ?>
                ...
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="get" class="needs-validation mt-3" action="<?php echo e(url('/pendingFunding')); ?>">
                                <div class="row">
                                    <div class="col-lg-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/admin/pendingFunding.blade.php ENDPATH**/ ?>