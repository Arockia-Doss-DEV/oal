<?php $__env->startSection('title', 'Create Subscription'); ?>
                                             ...
                                             <?php echo Form::open(['url' => '/subscriptionSave', 'files' => true, 'id' => 'subscriptionform', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off" ]); ?>
                                                ...
                                                <div>
                                                    ...
                                                    <section>
                                                        ...
                                                        <div class="row">
                                                                <?php echo $__env->make("admin.elements.newSubscription.subscription", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        </div>
                                                    </section>
                                                    ...
                                                    <section>
                                                        ...
                                                        <?php echo $__env->make("admin.elements.newSubscription.additional", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    </section>
                                                    ...
                                                    <section>
                                                        ...
                                                        <?php echo $__env->make("admin.elements.newSubscription.document", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    </section>
