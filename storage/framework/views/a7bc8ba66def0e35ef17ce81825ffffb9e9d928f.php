		...
		<div class="form-group">
			...
			<select class="form-control" name="lc_phone_prefix" id="lc_phone_prefix" data-parsley-group="block2" required>
                <?php $__currentLoopData = $phone_prefix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($data['code']); ?>" <?php echo e($data['code'] == @$subscription->lc_phone_prefix ? "selected" : ''); ?>><?php echo e($data['country']); ?></option>
		...
		<div class="col-lg-12">
			<div class="form-group">
				...
				<div class=" mt-2 string-check string-check-bordered-base mb-2">
					...
					<input type="radio"  name="ownership_status" id="ownership_status1" value="1" <?php echo e($edit_ownership_status == '1' ? 'checked' : ''); ?> data-parsley-group="block2"  required>
				...
				<div class="string-check string-check-bordered-base mb-2">
					...
					<input type="radio"  name="ownership_status" id="ownership_status2" value="2" <?php echo e($edit_ownership_status == '2' ? 'checked' : ''); ?> data-parsley-group="block2" required>
				...
				<div class="string-check string-check-bordered-base mb-2">
					<input type="radio"   name="ownership_status" id="ownership_status3" value="3" <?php echo e($edit_ownership_status == '3' ? 'checked' : ''); ?> data-parsley-group="block2" required>
...
</div><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/investor/elements/additionalSubscription/additional.blade.php ENDPATH**/ ?>