<?php $__env->startSection('title', 'Update Price'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="dealing_date" value="<?php echo e($price->dealing_date); ?>" class="form-control datepicker" placeholder="Dealing Date">
                                            </div>
                                        </div>
                                        <div class="col-xs-4 col-sm-12 col-md-3">
                                            <div class="form-group">
                                                <strong>Latest Price :</strong>
                                                <input type="text" name="latest_price" value="<?php echo e($price->latest_price); ?>" class="form-control" placeholder="Latest Price">
                                            </div>
                                        </div>
                                        <div class="col-xs-4 col-sm-12 col-md-3">
                                            <div class="form-group">
                                                <strong> <?php echo e($classType == 1 ? 'Quarterly Return :' : 'Monthly Return :'); ?> </strong>
                                                <input type="text" name="quarterly_return" value="<?php echo e($price->quarterly_return); ?>" class="form-control" placeholder="<?php echo e($classType == 1 ? 'Quarterly Return' : 'Monthly Return'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-3">
                                            <div class="form-group">
                                                <strong>Cumulative Return :</strong>
                                                <input type="text" name="ytd_return" value="<?php echo e($price->ytd_return); ?>" class="form-control" placeholder="Cumulative Return">
                                            </div>
                                        </div>
