<?php $__env->startSection('title', 'Redemption Request'); ?>
                ...
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <h4 class="card_title">Redemption Request</h4>
                                </div>
                            </div>

                            

                            <form method="get" class="needs-validation mt-3" action="<?php echo e(url('/maturedRequest')); ?>">
                                <div class="row">
                                    <div class="col-lg-4">
                                ...
                                <table id="example" class="table table-striped table-bordered">
                                    ...
                                    <?php if($subscriptions->count() > 0): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <span class="badge badge-soft-info mt-2 mr-2">Active</span> 
                                            </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/admin/matured_request.blade.php ENDPATH**/ ?>