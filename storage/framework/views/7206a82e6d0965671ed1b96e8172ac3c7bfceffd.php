        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="services-measonry" class="cbp">
                    ...
                    <?php $__currentLoopData = $recentNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $recent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="cbp-item digital brand design">
                            <div class="services-main">
                                <div class="image bottom10">
                                    ...
                                    <div class="overlay">
                                        <a href="<?php echo e(url('newsletter-details.html/'.$recent->id)); ?>" class="overlay_center border_radius"><i class="fa fa-eye"></i></a>
                                    </div>
                                </div>
                                <div class="services-content brand text-center text-md-left">
                                    ...
                                    <p class="bottom15">
                                        <?php echo str_limit($recent->detail, 25); ?>
