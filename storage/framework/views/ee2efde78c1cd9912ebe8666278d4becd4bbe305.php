...
<body>
	...
	<?php
        $joint_source_of_wealth = explode(', ', $subscription->ja_source_of_wealth);
    ?>

	<table width="100%" class="number-table">
		<tbody>
			<?php $__currentLoopData = $joint_source_of_wealth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $source_of_wealth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
	...
	<?php if( !empty($subscription->ja_source_of_wealth_other) &&  in_array('Other', $joint_source_of_wealth) ){ ?>

	<table width="100%" class="number-table">
		<tbody>
			<tr>
		        <td class="font-15"><u class="dotted"> <?php echo e($subscription->ja_source_of_wealth_other); ?> </u></td>
			</tr>
		</tbody>
	</table>
	...
	<?php
        $joint_source_of_wealth_funds_comes = explode(', ', $subscription->ja_source_of_wealth_funds_comes);
    ?>

	<table width="100%" class="number-table">
		<tbody>
			<?php $__currentLoopData = $joint_source_of_wealth_funds_comes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $source_of_wealth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
					<td width="5%" class="mr-1"><input type="checkbox" checked /></td>
					<td  class="font-15"><?php echo e($source_of_wealth); ?></td>
				</tr>
	...
	<?php if( !empty($subscription->ja_source_of_wealth_funds_comes_other) &&  in_array('Other', $joint_source_of_wealth_funds_comes) ){ ?>

	<table width="100%" class="number-table">
		<tbody>
			<tr>
		        <td class="font-15"><u class="dotted"> <?php echo e($subscription->ja_source_of_wealth_funds_comes_other); ?> </u></td>
			</tr>
		</tbody>
	</table>
...
</html><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/pdf/jointSourceOfFundPdf.blade.php ENDPATH**/ ?>