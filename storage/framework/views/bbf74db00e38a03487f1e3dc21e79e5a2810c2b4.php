		...
		<div class="modal fade" id="changepasswordDataButton" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<?php echo Form::open(['url' => '/investor/changePassword', 'files' => true, 'id' => 'password-form', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off" ]); ?>
	...
	<script>
        ...
        $('#enable2FADataForm').submit(function(e) {
            ...
            if ( $(this).parsley().isValid() ) {
                ...
                axios.post(SITE_URL+'investor/enable2Fa',formData,{
                        headers: {
        ...
        $(document).on("click","#disable2FADataButton",function() {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.post(SITE_URL+'investor/disable2Fa',formData,{
                            headers: {
                                'Content-Type': 'multipart/form-data',
                                'X-CSRF-Token': csrfToken}}
                    ).then(function (response) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/investor/settings.blade.php ENDPATH**/ ?>