	...
	<script>
		...
		function jointApplicant() {
			...
			getSupportedDocuments();
		  	...
		  	console.log('joint_account_val '+ x);
		...
		function changeSubscriberType() {
			...
			getSupportedDocuments();
		  	...
		  	console.log('subscriber_type_val '+ x);
        ...
        $(document).on("click",".download_signed_applications",function() {
	        ...
	        if(subscriptionId){
	            ...
	            axios.post(SITE_URL+'admin/signedPdfApplicationsDownload',formData,{
	                    headers: {
	                        'Content-Type': 'multipart/form-data',
	                        'X-CSRF-Token': csrfToken
	                    }
...
<?php $__env->stopSection(); ?><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/admin/elements/subscriptionScript.blade.php ENDPATH**/ ?>