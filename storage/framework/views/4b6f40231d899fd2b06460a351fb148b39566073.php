    ...
    <nav class="navbar navbar-expand-lg transparent-bg static-nav">
        <div class="container">
            <a class="navbar-brand d-block d-sm-none" href="index.html">
                <img src="<?php echo e(asset('').'site/assets/img/oal_logo_2.png'); ?>" alt="logo" class="logo-default" style="width: 55px">
            ...
            <div class="collapse navbar-collapse">
                <a class="navbar-brand" href="index.html">
                    <img src="<?php echo e(asset('').'site/assets/img/oal_logo_2.png'); ?>" alt="logo" class="logo-default" style="width: 60px">
                    <span class="logo-default whitecolor">OLYMPUS ASSET LIMITED</span>                    
                    <img src="<?php echo e(asset('').'site/assets/img/oal_logo.png'); ?>" alt="logo" class="logo-scrolled" style="width: 54px">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown static">
                        <a class="nav-link <?php echo e((request()->is('index.html')) ? 'active' : ''); ?>" href="<?php echo e(url("index.html")); ?>">Home </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((request()->is('who-we-are.html')) ? 'active' : ''); ?>" href="<?php echo e(url("who-we-are.html")); ?>">Who We Are</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((request()->is('corporate-values.html')) ? 'active' : ''); ?>" href="<?php echo e(url("corporate-values.html")); ?>">Corporate Values</a>
                    </li>

                    <?php if(auth()->guard()->guest()): ?>
                    <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((request()->is('methdology.html')) ? 'active' : ''); ?>" href="<?php echo e(url("methdology.html")); ?>">Methodology</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((request()->is('newsletter.html')) ? 'active' : ''); ?>" href="<?php echo e(url("newsletter.html")); ?>">Newsletter</a>
                    </li>
                    <?php endif; ?>
    ...
    <div class="side-menu opacity-0 gradient-bg">
        ...
        <div class="inner-wrapper">
            ...
            <div class="side-footer w-100">
                ...
                <p class="whitecolor">&copy; <span id="year"></span><?= date('Y')?> Olympus Asset Limited (Company no: 165016)</p>
            </div>
        </div>
    </div>
