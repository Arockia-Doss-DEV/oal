...
<div class="row mt-4">
	...
	<div class="row sec2-form mt-1 PrincipalJointDocsListDiv">
		<div class="col-sm-12 col-md-6">
			<h6 class="pl-0 pt-2 principle-group-header">Please upload the following documents for principal holder:</h6>
    ...
    <div class="col-lg-12">
    	<div class="form-group manual_signed_doc mt-2">
...
</div><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/admin/elements/newSubscription/document.blade.php ENDPATH**/ ?>