<?php $__env->startSection('title', 'Upload Bank Slip'); ?>
 ...
 <div class="modal fade" id="updatepassportDataModel" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <?php echo Form::open(['url' => '/investor/uploadBankslipSave', 'files' => true, 'id' => 'formBankSlip', 'data-parsley-validate' => 'data-parsley-validate', 'autocomplete'=>"off" ]); ?>
