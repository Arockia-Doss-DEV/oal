<?php $__env->startSection('title', 'Confirm Message'); ?>
            ...
            <div class="content-wrapper">
                ...
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        ...
                        <?php echo Form::open(array('url' => '/messages/confirm', 'method'=>'POST', 'files' => true, 'id' => 'user-form', 'onSubmit'=>'return validateForm()', 'autocomplete'=>"off" )); ?>
												...
												foreach($sendDatas['users'] as $row) {
													...
													echo "<tr class='".$trclass."'>";
														...
														echo "<td>";
															...
															echo '<input type="checkbox" value="'.$row['id'].'" name="emailcheck[]" checked="'.$checked.'" class="'.$cls.'"> ';
