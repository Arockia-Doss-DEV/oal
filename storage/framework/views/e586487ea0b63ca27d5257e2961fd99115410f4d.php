<div class="row mt-4">
	<div class="col-lg-12 col-md-6 col-sm-12">
		<div class="form-group">
			...
			<input type="text" class="form-control" id="lc_name" name="lc_name" placeholder="Name" data-parsley-group="block2" value="<?php echo e($edit ? $subscription->lc_name : $subscriptionClassData->lc_name); ?>"  required>
		</div>
	</div>
	<div class="col-lg-12 col-md-6 col-sm-12">
		<div class="form-group">
			<label for="ip">Email *</label>
			<input type="email" class="form-control" id="lc_email" name="lc_email" placeholder="Email" data-parsley-group="block2" value="<?php echo e($edit ? $subscription->lc_email : $subscriptionClassData->lc_email); ?>" required>
		</div>
	</div>
	...
	<div class="col-lg-5 col-md-5 col-sm-12">
		<div class="form-group">
			...
			<input type="text" class="form-control" id="lc_phone_number" name="lc_phone_number" placeholder="Phone Number" data-parsley-group="block2" data-parsley-type="digits" value="<?php echo e($edit ? $subscription->lc_phone_number : $subscriptionClassData->lc_phone_number); ?>" required>
		</div>
	</div>
	...
	<div class="col-lg-5 col-md-5 col-sm-12">
		<div class="form-group">
			...
			<input type="text" class="form-control" id="lc_facsimile" name="lc_facsimile" placeholder="Facsimile" data-parsley-group="block2" value="<?php echo e($edit ? $subscription->lc_facsimile : $subscriptionClassData->lc_facsimile); ?>">
		</div>
	</div>
	...
	<div class="row sec2-form mt-3">
		<div class="col-lg-12 col-md-6 col-sm-12">
			<div class="form-group">
				...
				<?php if($additional){ ?>
				    <input type="hidden" id="legal_status" name="legal_status" data-parsley-group="block2" value="<?php echo e($edit ? $subscription->legal_status : $subscriptionClassData->legal_status); ?>">
			    ...
			    <?php }else{ ?>
			        <?php echo Form::select('legal_status', $legal_statusOption, $edit ? $subscription->legal_status : $subscriptionClassData->legal_status, ['class' => 'form-control', 'id' => 'legal_status', 'data-parsley-group'=>"block2", 'required', 'onchange'=>"changeLegal_status()"]); ?>
		...
		<div class="col-lg-12 col-md-6 col-sm-12 legal_status_other_div">
			<div class="form-group">
				...
				<input type="text" class="form-control" id="legal_status_other" name="legal_status_other" placeholder="Please Specify" data-parsley-group="block2" value="<?php echo e($edit ? $subscription->legal_status_other : $subscriptionClassData->legal_status_other); ?>">
			</div>
		</div>
		<div class="col-lg-12">
			<div class="form-group">
				...
				<input type="text" class="form-control" id="jurisdiction_under" name="jurisdiction_under" placeholder="Please Specify" data-parsley-group="block2" value="<?php echo e($edit ? $subscription->jurisdiction_under : $subscriptionClassData->jurisdiction_under); ?>">
			</div>
		</div>
		<div class="col-lg-12">
			<div class="form-group">
		...
		<div class="row mt-4 sec2-form" id="ownership_status_details">
			<div class="row col-md-12">	
				<div class="col-lg-12 col-md-6 col-sm-12">
					<div class="form-group">
						<label for="date">Name</label>
						<input type="text" class="form-control" id="os_name" name="os_name" placeholder="Name" data-parsley-group="block2" value="<?php echo e($edit ? $subscription->os_name : $subscriptionClassData->os_name); ?>">
					</div>
				</div>
				<div class="col-lg-12 col-md-6 col-sm-12">
					<div class="form-group">
						<label for="time">Address Line 1</label>
						<input type="text" class="form-control" id="os_address_line1" name="os_address_line1"  placeholder="Address Line1" data-parsley-group="block2" value="<?php echo e($edit ? $subscription->os_address_line1 : $subscriptionClassData->os_address_line1); ?>">
					</div>
				</div>
				<div class="col-lg-12 col-md-6 col-sm-12">
					<div class="form-group">
						<label for="time">Address Line 2</label>
						<input type="text" class="form-control" id="os_address_line2" name="os_address_line2" placeholder="Address Line2" data-parsley-group="block2" value="<?php echo e($edit ? $subscription->os_address_line2 : $subscriptionClassData->os_address_line2); ?>">
					</div>
				</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="os_city" name="os_city"  placeholder="City" data-parsley-group="block2" value="<?php echo e($edit ? $subscription->os_city : $subscriptionClassData->os_city); ?>">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="form-group">
						<label for="exampleFormControlSelect1">Country</label>
						<?php echo Form::select('os_country', $countries, $edit ? $subscription->os_country : $subscriptionClassData->os_country, ['class' => 'form-control', 'id'=>'os_country_id', 'required', 'data-parsley-group'=>"block2"]); ?>
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="os_post_code" name="os_post_code" placeholder="Post Code" data-parsley-group="block2" data-parsley-type="digits" value="<?php echo e($edit ? $subscription->os_post_code : $subscriptionClassData->os_post_code); ?>">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="form-group">
				...
				<div class="row col-md-12">
					<div class="col-sm-12 col-md-6 p-1">
			            ...
			            <div class="row col-lg-12 mt-3 individual origin_wealth_other" id="origin_wealth_other">
		                    <input type="text" name="origin_fund_wealth_other" id="origin_fund_wealth_other" class="form-control search-input" value="<?php echo e($edit ? $subscription->origin_fund_wealth_other : $subscriptionClassData->origin_fund_wealth_other); ?>" data-parsley-group="block2" maxlength="50">
		                </div>
				...
				<div class="col-sm-12 col-md-6 p-1">
		            ...
		            <div class="col-md-12 col-md-6 p-1 mt-3 individual source_of_wealth_other" id="individual_source_of_wealth_other">
						<div class="form-group">
							...
							<?php echo Form::select('source_of_wealth_other', $sourceWealthOtherOptions, $edit ? @$subscription->source_of_wealth_other : $subscriptionClassData->source_of_wealth_other,
	    ...
	    <div class="col-lg-12">
			<div class="row col-md-12">
				<div class="col-sm-12 col-md-12">
		    		<div class="row">
						<div class="mt-2 string-check string-check-bordered-base mb-2 mr-3">
							<input type="radio" name="ja_peb_declaration_status" id="ja_peb_declaration_status1" value="1" <?php echo e($edit_ja_peb_declaration_status == '1' ? 'checked' : ''); ?> data-parsley-group="block2" data-parsley-errors-container="#jointPebDeclarationStatus-errors">
						...
						<div class="mt-2 string-check string-check-bordered-base mb-2 mr-3">
							<input type="radio" name="ja_peb_declaration_status" id="ja_peb_declaration_status2" value="2" <?php echo e($edit_ja_peb_declaration_status == '2' ? 'checked' : ''); ?> data-parsley-group="block2" data-parsley-errors-container="#jointPebDeclarationStatus-errors">
							<label class="string-check-label" for="peb-form">
								<span class="ml-2">Yes - If yes, please specify (functions held, when and for how long, etc...) </span>
							</label>
						</div>
				...
				<div class="row col-md-12">
					<div class="col-sm-12 col-md-6 p-1">
			            ...
			            <div class="row col-lg-12 mt-3 joint ja_origin_wealth_other" id="ja_origin_wealth_other">
		                    <input type="text" name="ja_origin_fund_wealth_other" id="ja_origin_fund_wealth_other" class="form-control search-input" value="<?php echo e($edit ? $subscription->ja_origin_fund_wealth_other : $subscriptionClassData->ja_origin_fund_wealth_other); ?>" data-parsley-group="block2" maxlength="50">
		                </div>
				...
				<div class="col-sm-12 col-md-6 p-1">
		            ...
		            <div class="col-md-12 col-md-6 p-1 mt-3 joint ja_source_of_wealth_other" id="joint_source_of_wealth_other">
						<div class="form-group">
							...
							?>
							<?php echo Form::select('ja_source_of_wealth_other', $jaSourceWealthOtherOptions, $edit ? @$subscription->ja_source_of_wealth_other : $subscriptionClassData->ja_source_of_wealth_other,
...
</div><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/investor/elements/additionalClass/additional.blade.php ENDPATH**/ ?>