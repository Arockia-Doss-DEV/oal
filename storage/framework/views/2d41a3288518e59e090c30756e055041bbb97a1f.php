    ...
    <div class="container whitebox">
        <div class="row d-flex justify-content-center">
            <div class="col-md-10 text-center wow fadeInUp">
                ...
                <h5 class="text-success"> <a href="<?php echo e(asset('admin/images/docs/private-placement-memorandum-signed.pdf')); ?>">Click to download the document</a></h5>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container whitebox">
        <div class="row d-flex justify-content-center">
            <div class="col-md-10 text-center wow fadeInUp">
                ...
                <h5 class="text-success"> <a href="<?php echo e(asset('admin/images/docs/class-b-participating-shares-prospectus-supplement.pdf')); ?>">Click to download the document</a></h5>
...
</html><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/site/privatePlacementMemorandum.blade.php ENDPATH**/ ?>