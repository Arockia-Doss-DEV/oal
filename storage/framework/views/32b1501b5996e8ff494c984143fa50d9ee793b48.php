...
<div class="row mt-4">
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="form-group">
			...
			<?php if($additional){ ?>
			    <input type="hidden" id="subscriber_type" name="subscriber_type" data-parsley-group="block3" value="<?php echo e($subscription->subscriber_type); ?>">
			...
			<?php }else{ ?>
			    <?php echo Form::select('subscriber_type', $subscriber_typeOption, $subscription->subscriber_type, ['class' => 'form-control', 'id' => 'subscriber_type', 'data-parsley-group'=>"block3", 'required', 'onchange'=>"changeSubscriberType()", 'placeholder' => 'Please Select' ]); ?>
		...
		<div class="row col-md-12 col-sm-12 col-10 mt-3">
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype12" attr-sub-type="12" attr-remarks="Professional/Bank Reference" data-height="300" data-default-file="<?php echo e(asset($default_bank)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype12-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype13" attr-sub-type="13" attr-remarks="Curriculum Vitae" data-height="300" data-default-file="<?php echo e(asset($default_cv)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype13-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype14" attr-sub-type="14" attr-remarks="Address Proof" data-height="300" data-default-file="<?php echo e(asset($default_bank)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype14-errors" data-remove-required="0"/>
					</div>
					<div id="subtype14-errors"></div>
				</div>
			</div>
			
			<div class="col-md-6 col-sm-8 col-10 principal-holder-source-fund">
				<div class="form-group">
					<label for="ip">Principal Holder's Proof Of Source Of Funds And Wealth
					</label>
					<div class="col-lg-9 col-md-6 col-sm-12 p-1">
						<input type="file" class="dropify" id="subtype15" attr-sub-type="15" attr-remarks="Principal Proof Of Source Of Funds And Wealth" data-height="300" data-default-file="<?php echo e(asset($default_bank)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype15-errors" data-remove-required="0"/>
					</div>
		...
		<div class="row col-md-12 col-sm-12 col-10">
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype24" attr-sub-type="24" attr-remarks="List of Directors"  data-height="300" data-default-file="<?php echo e(asset($default_bank)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype24-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype25" attr-sub-type="25" attr-remarks="List of Authorised Signatories" data-height="300" data-default-file="<?php echo e(asset($default_bank)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype25-errors" data-remove-required="0"/>
					</div>
		...
		<div class="row col-md-12 col-sm-12 col-10">
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					thereof, where applicable." data-height="300" data-default-file="<?php echo e(asset($default_bank)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype41-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12">
						...
						principals, being significant partners" data-height="300" data-default-file="<?php echo e(asset($default_bank)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype42-errors" data-remove-required="0"/>
					</div>
		...
		<div class="row col-md-12 col-sm-12 col-10">
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype51" attr-sub-type="51" attr-remarks="Certificate of incorporation"  data-height="300" data-default-file="<?php echo e(asset($default_bank)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype51-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype52" attr-sub-type="52" attr-remarks="License certificate" data-height="300" data-default-file="<?php echo e(asset($default_bank)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype52-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype55" attr-sub-type="55" attr-remarks="Copy of latest reports and accounts"  data-height="300" data-default-file="<?php echo e(asset($default_bank)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype55-errors" data-remove-required="0"/>
					</div>
		...
		<div class="row col-md-12 col-sm-12 col-10">
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype63" attr-sub-type="63" attr-remarks="List of Authorised Signatories" data-height="300" data-default-file="<?php echo e(asset($default_bank)); ?>" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype63-errors" data-remove-required="0"/>
					</div>
	...
	<div class="col-lg-12 PrincipalJointDocsListDiv">
		<h5 class="pl-0 pt-0 principle-header">Optional: Additional Supporting Documents: </h5>
	</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group manual_signed_joint_pep_doc">
		            ...
		            <input type="file" class="manual_signed_joint_pep_docs" name="joint_pep_file" required/>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="form-group manual_signed_joint_fund_doc">
		            ...
		            <input type="file" class="manual_signed_joint_fund_docs" name="joint_fw_file" required/>
				</div>
			</div>
		</div>
	</div>
...
</div><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/admin/elements/editSubscription/editDocument.blade.php ENDPATH**/ ?>