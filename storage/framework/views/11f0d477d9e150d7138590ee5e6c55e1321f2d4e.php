        	...
        	if ($('#additionalSubscriptionForm').parsley().validate()) {
	            ...
	            axios.post(SITE_URL+'subscriptionSave',formData,{
                    ...
                    if(item === "success"){
                        ...
                        Swal.fire('Great Job !','User subcription was saved successfully !!!','success');
                    }else{
...
<?php $__env->stopSection(); ?><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/admin/elements/additionalSubscriptionScript.blade.php ENDPATH**/ ?>