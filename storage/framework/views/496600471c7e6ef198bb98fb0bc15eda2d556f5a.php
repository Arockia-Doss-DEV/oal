        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="bg-white heading_space_half wow fadeInUp text-center p-3 shadow">
                    ...
                    <form class="widget_search" method="get" class="needs-validation mt-3" action="<?php echo e(url('/newsletter.html')); ?>">
                        <div class="input-group">
                            <label for="search" class="d-none"></label>
                            <input type="text" name="q" class="form-control" placeholder="Search..." id="search" required>
                            <button type="submit" id="searchSubmitId" class="input-group-addon"><i class="fa fa-search"></i> </button>
                        </div>
                    </form>
                </div>
            </div>
