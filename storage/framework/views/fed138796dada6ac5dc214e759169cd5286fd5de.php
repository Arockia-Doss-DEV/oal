...
<div class="row mt-4">
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="form-group">
			...
			<?php if($additional){ ?>
			    <input type="hidden" id="subscriber_type" name="subscriber_type" data-parsley-group="block3" value="<?php echo e($edit ? $subscription->subscriber_type : $subscriptionClassData->subscriber_type); ?>">
			...
			<?php }else{ ?>
			    <?php echo Form::select('subscriber_type', $subscriber_typeOption, $edit ? $subscription->subscriber_type : $subscriptionClassData->subscriber_type, ['class' => 'form-control', 'id' => 'subscriber_type', 'data-parsley-group'=>"block3", 'required', 'onchange'=>"changeSubscriberType()", 'placeholder' => 'Please Select' ]); ?>
...
</div><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/investor/elements/additionalClass/document.blade.php ENDPATH**/ ?>