...
<body>
	...
	<table width="100%" class="number-table">
		<tbody>
			<tr>
				<td width="5%" class="font-15"><input type="checkbox" <?php echo e(($subscription->peb_declaration_status == 1) ? "checked" : ''); ?> /></td>
				<td  class=" font-15">No  </td>
			</tr>
			<tr>
				<td width="5%" class="font-15"><input type="checkbox" <?php echo e(($subscription->peb_declaration_status == 2) ? "checked" : ''); ?> /></td>
	...
	<?php elseif($subscription->peb_declaration_status == 2): ?>
		...
		<table width="100%" class="number-table">
			<tbody>
				...
				<?php $__currentLoopData = $principal_origin_fund_wealth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $origin_fund_wealth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		...
		<table width="100%" class="number-table">
			<tbody>
				<tr>
					<td class="font-15"><u class="dotted"> <?php echo e($subscription->origin_fund_wealth_other); ?> </u></td>
				</tr>
			</tbody>
		</table>
...
</html><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/pdf/PEPDeclarationPdf.blade.php ENDPATH**/ ?>