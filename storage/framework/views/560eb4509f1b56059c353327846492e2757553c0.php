	...
	<script>
		$(document).ready(function() {
	        ...
	        form.children("div").steps({
	            ...
	            onStepChanging: function (event, currentIndex, newIndex){
		            ...
		            console.log("saveScubscriptionDraft called");
		            saveScubscriptionDraft();

		            // getUserSourceWealthDocuments();
            ...
            // var peb_declaration_status_value = document.querySelector("input[type='radio'][name=peb_declaration_status]:checked").value;

            // var peb_declaration_status_value = document.querySelector('input[name="peb_declaration_status"]:checked').value;
            ...
            ///////////////////////
            // var origin_fund_wealth = $('#origin_fund_wealth').val();

            // var origin_fund_wealth = $(".origin_fund_wealth").is(":checked").val();
            // if(origin_fund_wealth == "Other"){
	        ...
	        // var source_of_wealth = $('#source_of_wealth').val();
         //    if(source_of_wealth == "Other"){
         ...
         //    }
            ...
            // var ja_peb_declaration_status_value = document.querySelector('input[name="ja_peb_declaration_status"]:checked').value;
            ...
            // var ja_origin_fund_wealth = $('#ja_origin_fund_wealth').val();
            // if(ja_origin_fund_wealth == "Other"){
	        ...
	        // var ja_source_of_wealth = $('#ja_source_of_wealth').val();
         //    if(ja_source_of_wealth == "Other"){
		...
		function jointApplicant() {
			...
			if(x == 2){
				...
				console.log('is_joint yes onchange clicked');
				...
				// document.getElementById("joint_account_holder_docs_upload").style.display = 'block';
				...
				console.log('is_joint no onchange clicked');
				...
				// document.getElementById("joint_account_holder_docs_upload").style.display = 'none';
		...
		// $(".investment_class_b").click(function() {
		//     if($(this).is(":checked")) {
		//     	console.log('checked')
        ...
        function saveScubscriptionDraft(){
            ...
            axios.post(SITE_URL+'investor/subscriptionSaveDraft',formData,{
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'X-CSRF-Token': csrfToken}}
            ).then(function(response){
        ...
        // function getUserSourceWealthDocuments() {
        ...
        function saveScubscription(){
        	if ($('#subscriptionform').parsley().validate()) {
	            ...
	            axios.post(SITE_URL+'investor/subscriptionSave',formData,{
	                    headers: {
	                        'Content-Type': 'multipart/form-data',
	                        'X-CSRF-Token': csrfToken}}
	            ).then(function(response){
...
<?php $__env->stopSection(); ?><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/investor/elements/subscriptionScript.blade.php ENDPATH**/ ?>