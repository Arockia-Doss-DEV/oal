		...
		<div class="login-box animated fadeInDown">
			<div class="">
    			<a class="brand-logo" href="<?php echo e(url('/index.html')); ?>">
                    ...
                    <img src="<?php echo e(asset('site/assets/img/oal_logo_2.png')); ?>" alt="OAL Dashboard" title="OAL Dashboard" class='login-log' />
...
unset($__errorArgs, $__bag); ?>" name="otp" value="<?php echo e(old('otp')); ?>" placeholder='OTP' id='users-otp' required="required" data-parsley-type="digits" data-parsley-minlength="6" data-parsley-maxlength="6" data-parsley-group="group-2">
                                    ...
                                    <div class="d-block forgot-btn text-center">
                                        <a href="<?php echo e(route('password.request')); ?>" class="text-dark text-capitalize">Forgot Password?</a>
        ...
        <div class="modal fade" id="enable2ForgotFADataModel" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <?php echo Form::open(['url' => '/forgot/twofa', 'files' => true, 'id' => 'enableForgot2FADataForm', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off" ]); ?>
