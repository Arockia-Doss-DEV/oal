        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-10 text-center wow fadeInUp">
                ...
                <div>     
                    ...
                    {{-- <img src="{{asset('').'site/assets/img/barchart.png'}}" class="img-fluid" alt="Responsive image"> --}}
                                ...
                                <tr>
                                    @if ($value != "2019")
                                        ...
                                        @for ($i=0; $i < 4; $i++)
                                            ...
                                            @if (!empty($cumulative_data[$value][$i]->quarterly_return))

                                                @if ($value == "2019")
                                                    <td>{{ $cumulative_data[$value][$i]->quarterly_return }}</td>
                                                @else 
