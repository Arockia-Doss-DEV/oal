...
<!--morph text js-->
<script src="{!! asset('site/assets/js/morphext.min.js') !!}"></script>

<!--tooltip js-->
<!-- <script src="assets/js/tooltipster.min.js"></script> -->
<!--Cubefolio Gallery-->
<script src="{!! asset('site/assets/js/jquery.cubeportfolio.min.js') !!}"></script>
<!--Revolution SLider-->
<script src="{!! asset('site/assets/js/revolution/jquery.themepunch.tools.min.js') !!}"></script>
<script src="{!! asset('site/assets/js/revolution/jquery.themepunch.revolution.min.js') !!}"></script>
<!-- SLIDER REVOLUTION 5.0 EXTENSIONS -->
<script src="{!! asset('site/assets/js/revolution/extension/revolution.extension.actions.min.js') !!}"></script>
<script src="{!! asset('site/assets/js/revolution/extension/revolution.extension.carousel.min.js') !!}"></script>
<script src="{!! asset('site/assets/js/revolution/extension/revolution.extension.kenburn.min.js') !!}"></script>
<script src="{!! asset('site/assets/js/revolution/extension/revolution.extension.layeranimation.min.js') !!}"></script>
<script src="{!! asset('site/assets/js/revolution/extension/revolution.extension.migration.min.js') !!}"></script>
<script src="{!! asset('site/assets/js/revolution/extension/revolution.extension.navigation.min.js') !!}"></script>
<script src="{!! asset('site/assets/js/revolution/extension/revolution.extension.parallax.min.js') !!}"></script>
<script src="{!! asset('site/assets/js/revolution/extension/revolution.extension.slideanims.min.js') !!}"></script>
<script src="{!! asset('site/assets/js/revolution/extension/revolution.extension.video.min.js') !!}"></script>
