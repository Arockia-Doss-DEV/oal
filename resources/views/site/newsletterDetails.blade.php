                            ...
                            <div class="services-main">
                                <div class="image bottom10">
                                    <div class="image">
                                        ...
                                        <a class="image" href="http://localhost/oal-live-class/newsletter-details.html/71">
                                            <img src="http://localhost/oal-live-class/project_img/newsletter/images/1660147448864px-Official_photo_of_Speaker_Nancy_Pelosi_in_2019.jpg" alt="image" class="img-responsive" style="height: 236px;">
                                        </a>
                                ...
                                <div class="services-content brand text-center text-md-left">
                                    <h3 class="bottom10 darkcolor" style="font-size: 15px;">
                                        <a href="">The Global Economy in Crisis a.</a>
                                    </h3>
                                    <ul class="meta-tags top15 bottom15">
                                        <li><a href="javascript:void(0);"><i class="fas fa-calendar-alt"></i></a></li>
                                        <li><a href="javascript:void(0);"> <i class="far fa-user"></i> admin </a></li>
                                    </ul>
                                    <p class="bottom15">
                                        German Economics Minister Robert Habeck was quoted in the press last week to say that it’sGerman Economics Minister Robert Habeck was quoted in the press last week to say that it’sGerman Economics Minister Robert Habeck was quoted in the press last week to say that it’sGerman Economics Minister Robert Habeck was quoted in the press last week to say that it’s&...
                                    </p>
                                </div>
                            </div>
                        </div> --}}
