    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div>
                    <img src="{{asset('').'site/assets/img/oal_logo.webp'}}" width="40px">
                </div> 
        ...
        <div id="rev_main" class="rev_slider fullwidthabanner white" data-version="5.4.1">
            <ul>
                ...
                <li data-index="rs-01" data-transition="fade" data-slotamount="default" data-easein="Power100.easeIn" data-easeout="Power100.easeOut" data-masterspeed="2000" data-fsmasterspeed="1500" data-param1="01">  
                    ...
                    <img src="{{asset('').'site/assets/img/mainbanner-1.jpg'}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                ...
                <li data-index="rs-02" data-transition="fade" data-slotamount="default" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="2000" data-fsmasterspeed="1500" data-param1="02">
                    ...
                    <img src="{{asset('').'site/assets/img/mainbanner-4.jpg'}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
        ...
        {{-- <div id="rev_main" class="rev_slider fullwidthabanner white" data-version="5.4.1">
            <ul> --}}
                ...
                {{-- <li data-index="rs-02" data-transition="fade" data-slotamount="default" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="2000" data-fsmasterspeed="1500" data-param1="02"> --}}
                    ...
                    {{-- <div class="overlay overlay-dark opacity-5"></div>
                    <img src="{{asset('').'site/assets/img/mainbanner-2.jpg'}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina> --}}
                ...
                {{-- <li data-index="rs-03" data-transition="fade" data-slotamount="default" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="2000" data-fsmasterspeed="1500" data-param1="03"> --}}
                    ...
                    {{-- <div class="overlay overlay-dark opacity-5"></div>
                    <img src="{{asset('').'site/assets/img/mainbanner-3.jpg'}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina> --}}
            ...
            <div class="row align-items-center text-center py-4">
                <div class="col-lg-4 col-md-4 col-sm-4 bottom10">
                    <div class="counters whitecolor top10 bottom10">
                        <span class="count_nums font-light" data-to="{{ $price->latest_price}}" data-speed="2500" data-decimals="4"> </span>
                    </div>
                    <h3 class="font-light whitecolor top10 count_sub_text">Latest Price (USD)</h3>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 my-5 my-sm-0">
                   <div class="counters whitecolor top10 bottom10">
                        <span class="count_days font-light"> {{ date('d-M-y', strtotime($price->dealing_date)) }}</span>
                    </div>
                    <h3 class="font-light whitecolor top10 count_sub_text">Last Dealing Date</h3>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 bottom10">
                    <div class="counters whitecolor top10 bottom10">
                        <span class="count_nums font-light" data-to="{{ $price->ytd_return}}" data-speed="2500" data-decimals="2"> </span>
                    </div>
    ...
    <div class="countBottom">
        {{-- <div class="container"> --}}
            ...
            <div class="row align-items-center text-center py-4">
                ...
                {{-- <div class="col-lg-2 col-md-4 col-sm-4 bottom10">
                    <h3 class="font-light whitecolor top10 count_sub_text">Class A</h3>
                    <br>
                    <h3 class="font-light whitecolor top10 count_sub_text">Class B</h3>
                </div> --}}

                <div class="col-lg-4 col-md-4 col-sm-4 bottom10">
                    <div class="counters whitecolor top10 bottom10">
                        <span class="count_nums font-light" data-to="{{ $class_a_price->latest_price}}" data-speed="2500" data-decimals="4"> </span>
                    </div>
                    <h3 class="font-light whitecolor top10 count_sub_text">Class A Latest Price (USD)</h3>

                    <br>
                    <div class="counters whitecolor top10 bottom10">
                        <span class="count_nums font-light" data-to="{{ $class_b_price->latest_price}}" data-speed="2500" data-decimals="4"> </span>
                    </div>
                    <h3 class="font-light whitecolor top10 count_sub_text">Class B Latest Price (USD)</h3>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 my-5 my-sm-0">
                    <div class="counters whitecolor top10 bottom10">
                        <span class="count_days font-light"> {{ date('d-M-y', strtotime($class_a_price->dealing_date)) }}</span>
                    </div>
                    <h3 class="font-light whitecolor top10 count_sub_text">Class A Last Dealing Date</h3>

                    <br>
                    <div class="counters whitecolor top10 bottom10">
                        <span class="count_days font-light"> {{ date('d-M-y', strtotime($class_b_price->dealing_date)) }}</span>
                    </div>
                    <h3 class="font-light whitecolor top10 count_sub_text">Class B Last Dealing Date</h3>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 bottom10">
                    <div class="counters whitecolor top10 bottom10">
                        <span class="count_nums font-light" data-to="{{ $class_a_price->ytd_return}}" data-speed="2500" data-decimals="2"> </span>
                    </div>
                    <h3 class="font-light whitecolor top10 count_sub_text">Class A Latest Cumulative Return (%)</h3>

                    <br>
                    <div class="counters whitecolor top10 bottom10">
                        <span class="count_nums font-light" data-to="{{ $class_b_price->ytd_return}}" data-speed="2500" data-decimals="2"> </span>
                    </div>
        ...
        <div class="row d-flex justify-content-center">
                ...
                <div class="cbp-item digital brand design">
                    <div class="services-main">
                        <div class="image bottom10">
                            <div class="image"><img alt="SEO" src="{{asset('').'site/assets/img/banner-1.jpg'}}"></div>
                            <div class="overlay">
            ...
            <div class="col-lg-4 wow fadeInRight" data-wow-delay="300ms">
                <div class="cbp-item digital graphics">
                    <div class="services-main">
                        <div class="image bottom10">
                            <div class="image"><img alt="SEO" src="{{asset('').'site/assets/img/banner-2.jpg'}}"></div>
                            <div class="overlay">
    ...
    <div class="container">
        ...
        <div class="row no-gutters">
            <div class="col-lg-4 col-md-6 content-item wow fadeInUp d-flex align-items-center justify-content-center" data-wow-delay="300ms">
                <div>
                    <a href="https://www.afrasiabank.com" target="blank"><img alt="" src="{{asset('').'site/assets/img/logo/afrasia.webp'}}" width="100px" class="mt-n2"></a>
            ...
            <div class="col-lg-4 col-md-6 content-item wow fadeInUp d-flex align-items-center justify-content-center" data-wow-delay="300ms">
                <div>
                    <a href="https://eservices.mas.gov.sg/cisnetportal/jsp/list.jsp" target="blank"><img alt="" src="{{asset('').'site/assets/img/Hera-Fund-LogoSG.png'}}" width="70px" class="mt-2"></a>
            ...
            <div class="col-lg-4 col-md-6 content-item wow fadeInUp d-flex align-items-center justify-content-center" data-wow-delay="300ms">
                <div>
                    <a href="https://www.bdo.mu" target="blank"><img alt="" src="{{asset('').'site/assets/img/logo/bdo.webp'}}" width="90px" class="mt-3"></a>
            ...
            <div class="col-lg-4 col-md-6 content-item wow fadeInUp d-flex align-items-center justify-content-center" data-wow-delay="300ms">
                <div>
                    <a href="https://www.mauriexperta.com" target="blank"><img alt="" src="{{asset('').'site/assets/img/logo/mauri.webp'}}" width="100px" class="mt-2"></a>
            ...
            <div class="col-lg-4 col-md-6 content-item wow fadeInUp d-flex align-items-center justify-content-center" data-wow-delay="300ms">
                <div>
                    <a href="https://zetland.biz" target="blank"><img alt="" src="{{asset('').'site/assets/img/logo/zetland.webp'}}" width="50px" class="mt-2"></a>
            ...
            <div class="col-lg-4 col-md-6 content-item wow fadeInUp d-flex align-items-center justify-content-center" data-wow-delay="300ms">
                <div>
                    <a href="https://www.fscmauritius.org/en/being-supervised/register-of-licensees-search-by-name" target="blank"><img alt="" src="{{asset('').'site/assets/img/logo/fsc.webp'}}" width="50px"></a>
        ...
        <div class="contactus-wrapp shadow">
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                   ...
                   {{--  {!! Form::open(['files' => true, 'id' => 'contactUsForm', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off" ]) !!} --}}
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-2 col-sm-6">
                                ...
                                {{-- {!! Form::select('mobile_prefix', $phone_prefix, old('mobile_prefix'), ['class' => 'form-control', 'id'=>'mobile_prefix', "data-parsley-type"=>"digits", 'data-live-search'=>"false", 'required' =>'required']) !!} --}}
                            </div>
