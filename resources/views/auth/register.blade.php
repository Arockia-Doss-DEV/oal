                ...
                <div class="row register">
                    <div class="col-lg-12 col-md-12 ">
                        <div class="card card-margin">
                            ...
                            <div class="card-body">
                                {!! Form::open(['route' => 'register', 'files' => true, 'id' => 'user-form', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off" ]) !!}
                                    @csrf
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    {{-- <div class="col-lg-5 col-md-8 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" required  autofocus data-parsley-group="block1" oninput="this.value = this.value.toUpperCase()">
                                                    ...
                                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="address_line1" name="address_line1"  placeholder="Address Line 1" required value="{{ old('address_line1') }}" data-parsley-group="block1">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            <label for="time">Address Line 2</label>
                                                            <input type="text" class="form-control" id="address_line2" name="address_line2" placeholder="Address Line 2" value="{{ old('address_line2') }}" data-parsley-group="block1">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="kt-portlet__body">
                                                            <div class="kt-widget kt-widget--general-1">
                                                                <div class="kt-media kt-media--lg">
                                                                    <img src="{{asset('/admin/images/sample_image/googleauthenticator.png') }}" alt="image" style="max-width: 213px; height: 117px;">
                                                                </div>
