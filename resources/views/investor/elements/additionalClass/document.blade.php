...
<div class="row mt-4">
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="form-group">
			...
			<?php if($additional){ ?>
			    <input type="hidden" id="subscriber_type" name="subscriber_type" data-parsley-group="block3" value="{{ $edit ? $subscription->subscriber_type : $subscriptionClassData->subscriber_type }}">
		        <input type="text" readonly class="form-control" id="subscriber_type" name="subscriber_type" data-parsley-group="block3" value="{{ $subscriber_type_value }}">
			<?php }else{ ?>
			    {!! Form::select('subscriber_type', $subscriber_typeOption, $edit ? $subscription->subscriber_type : $subscriptionClassData->subscriber_type, ['class' => 'form-control', 'id' => 'subscriber_type', 'data-parsley-group'=>"block3", 'required', 'onchange'=>"changeSubscriberType()", 'placeholder' => 'Please Select' ]) !!}
			<?php } ?>
	...
	<div class="row mt-2 pl-3 status-individual" id="individual">
		...
		<div class="col-lg-12">
			...
			{{-- <br>
			<span class="text-danger">Note: Copies should be certified as true copies by one of the following: </span><br> --}}
		...
		<div class="row col-md-12 col-sm-12 col-10">
			...
			<div class=" col-md-6 col-sm-8 col-10">
				...
				<div class="col-lg-12 pl-0">
	                <div class="note-full"><span class="note">Note: </span> Click to download bank document <a href="{{ asset('admin/images/docs/bank-reference-template-v2.pdf') }}" target="_blank">Download </a></div>
	            </div><br>
			</div>
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
	...
	{{-- Joint Holder's Certified Documents --}}
		...
		<div class="row col-md-12 col-sm-12 col-10">
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					<label for="ip">Professional/Bank Reference</label>
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype72" attr-sub-type="72" attr-remarks="Joint Account’s Professional/Bank Reference" data-height="300" data-default-file="{{ asset($default_bank) }}" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype72-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					<label for="ip">Curriculum Vitae </label>
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype73" attr-sub-type="73" attr-remarks="Joint Account’s Curriculum Vitae" data-height="300" data-default-file="{{ asset($default_cv) }}" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype73-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					<label for="ip">Address Proof</label>
					<div class="col-lg-9 col-md-6 col-sm-12">
						<input type="file" class="dropify" id="subtype74" attr-sub-type="74" attr-remarks="Joint Account’s Address Proof" data-height="300" data-default-file="{{ asset($default_bank) }}" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype74-errors" data-remove-required="0"/>
					</div>
		...
		<div class="row col-md-12 col-sm-12 col-10">
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12 col-12 pl-0">
						<input type="file" class="dropify" id="subtype24" data-parsley-group="block3" attr-sub-type="24" attr-remarks="List of Directors"  data-height="300" data-default-file="{{ asset($default_bank) }}" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype24-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12 col-12 pl-0">
						<input type="file" class="dropify" id="subtype25" data-parsley-group="block3" attr-sub-type="25" attr-remarks="List of Authorised Signatories" data-height="300" data-default-file="{{ asset($default_bank) }}" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype25-errors" data-remove-required="0"/>
					</div>
		...
		<div class="row col-md-12 col-sm-12 col-10">
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					thereof, where applicable." data-height="300" data-parsley-group="block3" data-default-file="{{ asset($default_bank) }}" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype41-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12 col-12 pl-0">
						...
						principals, being significant partners" data-parsley-group="block3" data-height="300" data-default-file="{{ asset($default_bank) }}" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype42-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12 col-12 pl-0">
						<input type="file" class="dropify" id="subtype45" data-parsley-group="block3" attr-sub-type="45" attr-remarks="Copy of latest reports and accounts"  data-height="300" data-default-file="{{ asset($default_bank) }}" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype45-errors" data-remove-required="0"/>
					</div>
		...
		<div class="row col-md-12 col-sm-12 col-10">
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12 col-12 pl-0">
						<input type="file" class="dropify" id="subtype51" data-parsley-group="block3" attr-sub-type="51" attr-remarks="Certificate of incorporation"  data-height="300" data-default-file="{{ asset($default_bank) }}" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype51-errors" data-remove-required="0"/>
					</div>
		...
		<div class="row col-md-12 col-sm-12 col-10">
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12 col-12 pl-0">
						<input type="file" class="dropify" id="subtype61" data-parsley-group="block3" attr-sub-type="61" attr-remarks="Evidence of existence of institution" data-height="300" data-default-file="{{ asset($default_bank) }}" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype61-errors" data-remove-required="0"/>
					</div>
			...
			<div class=" col-md-6 col-sm-8 col-10">
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-6 col-sm-12 col-12 pl-0">
						<input type="file" class="dropify" id="subtype62" data-parsley-group="block3" attr-sub-type="62" attr-remarks="Mandate / Board Resolution by Directors"  data-height="300" data-default-file="{{ asset($default_bank) }}" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg" data-parsley-errors-container="#subtype62-errors" data-remove-required="0"/>
					</div>
