	...
	<div class="row sec2-form mt-3">
		<div class="col-lg-12 col-md-6 col-sm-12">
			<div class="form-group">
				...
				<input type="text" class="form-control" id="bank_name" name="bank_name" placeholder="Bank Name" data-parsley-group="block1" value="{{$edit ? $subscription->bank_name : $subscriptionClassData->bank_name }}" required>
			</div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-12">
			<div class="form-group">
				<label for="ip">Bank Address</label>
				<input type="text" class="form-control" id="bank_address" name="bank_address" placeholder="Bank Address" data-parsley-group="block1" value="{{$edit ? $subscription->bank_address : $subscriptionClassData->bank_address }}" required>
			</div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-12">
			<div class="form-group">
				<label for="phone">Account Name</label>
				<input type="text" class="form-control" id="account_name" name="account_name" placeholder="Account Name" data-parsley-group="block1" value="{{$edit ? $subscription->account_name : $subscriptionClassData->account_name }}" required>
			</div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-12">
			<div class="form-group">
				<label for="ip">Account Number</label>
				<input type="text" class="form-control" id="account_number" name="account_number" placeholder="Account Number" data-parsley-group="block1" data-parsley-type="digits" value="{{$edit ? $subscription->account_number : $subscriptionClassData->account_number }}" required>
			</div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-12">
			<div class="form-group">
				<label for="phone">Swift Code</label>
				<input type="text" class="form-control" id="swift_address" name="swift_address" placeholder="Swift Address" data-parsley-group="block1" value="{{$edit ? $subscription->swift_address : $subscriptionClassData->swift_address }}" required>
			</div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-12">
			<div class="form-group">
				<label for="ip">Bank IBAN#</label>
				<input type="text" class="form-control" id="bank_inan" name="bank_inan" placeholder="Bank IBAN" data-parsley-group="block1" value="{{$edit ? $subscription->bank_inan : $subscriptionClassData->bank_inan }}">
			</div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-12">
			<div class="form-group">
				<label for="ip">Reference</label>
				<input type="text" class="form-control" id="reference" name="reference" placeholder="Reference" data-parsley-group="block1" value="{{$edit ? $subscription->reference : $subscriptionClassData->reference }}">
			</div>
		</div>
		...
		<div class="row col-md-12">
			<div class="col-lg-12 col-md-8 col-sm-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="ja_name" name="ja_name" placeholder="Name" data-parsley-group="block1" value="{{$edit ? $subscription->ja_name : $subscriptionClassData->ja_name }}">
				</div>
			</div>
			<div class="col-lg-12 col-md-6 col-sm-12">
				<div class="form-group">
					<label for="time">Address Line 1</label>
					<input type="text" class="form-control" id="ja_address_line1" name="ja_address_line1" placeholder="Address Line1" data-parsley-group="block1" value="{{$edit ? $subscription->ja_address_line1 : $subscriptionClassData->ja_address_line1 }}">
				</div>
			</div>
			<div class="col-lg-12 col-md-6 col-sm-12">
				<div class="form-group">
					<label for="time">Address Line 2</label>
					<input type="text" class="form-control" id="ja_address_line2" name="ja_address_line2" placeholder="Address Line2" data-parsley-group="block1" value="{{$edit ? $subscription->ja_address_line2 : $subscriptionClassData->ja_address_line2 }}">
				</div>
			</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="form-group">
					<label for="datetime">City</label>
					<input type="text" class="form-control" id="ja_city" name="ja_city"  placeholder="City" data-parsley-group="block1" value="{{$edit ? $subscription->ja_city : $subscriptionClassData->ja_city }}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="form-group">
					<label for="credit-card">Post Code</label>
					<input type="text" class="form-control" id="ja_post_code" name="ja_post_code" placeholder="Post Code" data-parsley-group="block1" data-parsley-type="digits" value="{{$edit ? $subscription->ja_post_code : $subscriptionClassData->ja_post_code }}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="form-group">
