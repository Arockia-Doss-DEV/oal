<div class="row mt-4">
	...
	{{-- <div class="signedPdfDownload_div">
		<a href="{{ url('/investor/individual/pepPdfDownload') }}" class="btn btn-primary btn-wide btn-sm">Click to review and download your PEP's form</a>
	</div>

	<div class="signedPdfDownload_div">
		<a href="{{ url('/investor/individual/fundPdfDownload') }}" class="btn btn-primary btn-wide btn-sm">Click to review and download your SOFW's form</a>
	</div> --}}
	...
	<div class="row mt-2 pl-3 joint-applicant-blocks" id="joint-applicants">
		<div class="row col-md-12">
			...
			<div class="col-lg-12 col-md-6 col-sm-12">
				<div class="form-group">
					<label for="time">Address Line 1 *</label>
					<input type="text" class="form-control" id="ja_address_line1" name="ja_address_line1" placeholder="Address Line 1" data-parsley-group="block1" value="{{$edit ? $subscription->ja_address_line1 : old('ja_address_line1') }}">
				</div>
			</div>
			<div class="col-lg-12 col-md-6 col-sm-12">
				<div class="form-group">
					<label for="time">Address Line 2 *</label>
					<input type="text" class="form-control" id="ja_address_line2" name="ja_address_line2" placeholder="Address Line 2" data-parsley-group="block1" value="{{$edit ? $subscription->ja_address_line2 : old('ja_address_line2') }}">
				</div>
			</div>
