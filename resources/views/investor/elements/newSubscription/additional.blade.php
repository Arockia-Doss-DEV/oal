<div class="row mt-4">
		...
		<div class="form-group">
			...
			<select class="form-control" name="lc_phone_prefix" id="lc_phone_prefix" data-parsley-group="block2" required>
                @foreach ($phone_prefix as $key => $data)
                    <option value="{{$data['code']}}" {{ $data['code'] == @$subscription->lc_phone_prefix ? "selected" : '' }}>{{$data['country']}}</option>
                @endforeach
            </select>
	...
	<div class="col-lg-5 col-md-5 col-sm-12">
		<div class="form-group">
			...
			<input type="text" class="form-control" id="lc_phone_number" name="lc_phone_number" placeholder="Phone Number" data-parsley-group="block2" data-parsley-type="digits" value="{{$edit ? $subscription->lc_phone_number : old('lc_phone_number') }}" required>
		</div>
	</div>
	    ...
	    <div class="col-lg-12">
			<div class="row col-md-12">
				<div class="col-sm-12 col-md-12">
					...
					{{-- <div class="row mt-2" id="peb_declaration_other_status">
						<div class="col-lg-12 col-md-6 col-sm-12 p-1">
							<div class="form-group">
								<label for="time">If Other Please Specify</label>
								<input type="text" class="form-control" id="peb_declaration_other" name="peb_declaration_other" data-parsley-group="block2" value="{{ $edit ? $subscription->peb_declaration_other : old('peb_declaration_other') }}">
							</div>
						</div>
					</div> --}}
	    ...
	    <div class="col-lg-12">
			<div class="row col-md-12">
				<div class="col-sm-12 col-md-6 p-1">
		            ...
		            {{-- <div class="row col-lg-12 mt-3 individual source_of_wealth_other" id="source_of_wealth_other">
	                    <input type="text" name="source_of_wealth_other" id="source_of_wealth_other" class="form-control search-input" value="{{ $edit ? $subscription->source_of_wealth_other : old('source_of_wealth_other') }}" data-parsley-group="block2" maxlength="50">
	                </div> --}}
	    ...
	    <div class="col-lg-12">
			<div class="row col-md-12">
				<div class="col-sm-12 col-md-12">
					...
					{{-- <div class="row mt-2" id="ja_peb_declaration_other_status">
						<div class="col-lg-12 col-md-6 col-sm-12 p-1">
							<div class="form-group">
								<label for="time">If Other Please Specify</label>
								<input type="text" class="form-control" id="ja_peb_declaration_other" name="ja_peb_declaration_other" data-parsley-group="block2" value="{{ $edit ? $subscription->ja_peb_declaration_other : old('peb_declaration_other') }}">
							</div>
						</div>
					</div> --}}
	    ...
	    <div class="col-lg-12">
			<div class="row col-md-12">
				<div class="col-sm-12 col-md-6 p-1">
		            ...
		            {{-- <div class="row col-lg-12 mt-3 joint ja_source_of_wealth_other" id="joint_source_of_wealth_other">
	                    <input type="text" name="ja_source_of_wealth_other" id="ja_source_of_wealth_other" class="form-control search-input" value="{{ $edit ? $subscription->ja_source_of_wealth_other : old('ja_source_of_wealth_other') }}" data-parsley-group="block2" maxlength="50">
	                </div> --}}
