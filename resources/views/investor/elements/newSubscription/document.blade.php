...
<div class="row mt-4">
    ...
    {{-- <div class="col-lg-12">
        ...
        <div class="signedPdfDownload_div">
    		<a href="{{ url('/investor/signedPdfDownload') }}" target="_blank" download class="btn btn-primary btn-wide btn-sm">Click to review and download your application's form</a>
    	</div>
    </div>
 	--}}

 	<div class="col-lg-12">
        {{-- <span class="text-danger">Please download, sign and upload the application form</span> --}}
