                ...
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- <form method="get" class="needs-validation mt-3" action="{{ url('/pendingFunding')}}">
                                <div class="row">
                                    <div class="col-lg-4">
                            ...
                            <form method="get" class="needs-validation mt-3" action="{{ url('/fundReceived') }}">
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    @if ($subscriptions->count() > 0)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{-- <span class="badge badge-soft-info mt-2 mr-2">Pending Funding</span>  --}}
