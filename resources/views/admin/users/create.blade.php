            ...
            <div class="content-wrapper">
                ...
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        ...
                        {!! Form::open(array('route' => 'users.store', 'method'=>'POST', 'files' => true, 'id' => 'user-form', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off" )) !!}
                            <div class="card-body">
                                ...
                                <div class="row col-md-12">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('roles', $roles, old('roles'), ['placeholder' => 'Please select user role ...', 'class' => 'form-control user-role', 'id'=>'roles', 'required' =>'required']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-8 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required  oninput="this.value = this.value.toUpperCase()" autofocus placeholder="Name">
                                    ...
                                    <div class="col-lg-12 col-md-8 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Email" required data-parsley-group="block1" data-parsley-checkemail data-parsley-checkemail-message="Email Address already Exists" data-parsley-trigger="focusout">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Phone Number" data-parsley-type="digits" value="{{ old('mobile_no') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="address_line1" name="address_line1"  placeholder="Address  Line1" value="{{ old('address_line1') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('country', $countries, null, ['class' => 'form-control', 'id'=>'country_id', 'required']) !!}
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label for="credit-card">Post Code</label>
                                            <input type="text" class="form-control" id="postcode" name="post_code" placeholder="Post Code" value="{{ old('post_code') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
