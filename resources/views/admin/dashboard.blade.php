                            ...
                            <div class="row">
                                <div class="col-md-4 mt-4 pt-1">
                                    <select class="form-control select2" name="month" id="subscriptionMonth">
                                        ...
                                        <option value='1' {{ app('request')->input('month') == 1 ? 'selected' : '' }}>January</option>
                                        <option value='2' {{ app('request')->input('month') == 2 ? 'selected' : '' }}>February</option>
                                        <option value='3' {{ app('request')->input('month') == 3 ? 'selected' : '' }}>March</option>
                                        <option value='4' {{ app('request')->input('month') == 4 ? 'selected' : '' }}>April</option>
                                        <option value='5' {{ app('request')->input('month') == 5 ? 'selected' : '' }}>May</option>
                                        <option value='6' {{ app('request')->input('month') == 6 ? 'selected' : '' }}>June</option>
                                        <option value='7' {{ app('request')->input('month') == 7 ? 'selected' : '' }}>July</option>
                                        <option value='8' {{ app('request')->input('month') == 8 ? 'selected' : '' }}>August</option>
                                        <option value='9' {{ app('request')->input('month') == 9 ? 'selected' : '' }}>September</option>
                                        <option value='10' {{ app('request')->input('month') == 10 ? 'selected' : '' }}>October</option>
                                        <option value='11' {{ app('request')->input('month') == 11 ? 'selected' : '' }}>November</option>
                                        <option value='12' {{ app('request')->input('month') == 12 ? 'selected' : '' }}>December</option>
                                    </select>
                                </div>
                                <div class="col-md-4 mt-4 pt-1">
                                    <select class="form-control select2" name="year" id="subscriptionYear">
                                        ...
                                        @if(count($subscription_years) > 0)
                                            @foreach($subscription_years as $key => $year)
...
<script src="{{ asset('admin/js/components/legacy-sidebar/dashboard-msb.js') }}"></script>
