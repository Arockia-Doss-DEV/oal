                ...
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- <form method="get" class="needs-validation mt-3" action="{{ url('/pending')}}">
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    @if ($subscriptions->count() > 0)
                                        ...
                                        <tr>
                                            ...
                                            {{-- <td>     --}}
                                                ...
                                                {{-- <a class="table-view-card" href="{{ url('subscriptionView/'.$subscription->id) }}"><img src="{{ asset('assets/icons/view-icon.png') }}" alt="view icon" /></a>

                                                <a class="table-view-card" href="{{ url('subscriptionEdit/'.$subscription->id) }}"><img src="{{ asset('assets/icons/edit-icon.png') }}" alt="edit icon" /></a> --}}
