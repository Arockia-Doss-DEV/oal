<div class="row mt-4">
	<div class="col-lg-4 col-md-6 col-sm-12">
		<div class="form-group">
			...
			{!! Form::select('investment_class_type', $investmentClasses, $edit ? $subscription->investment_class_type : old('investment_class_type'), ['placeholder' => 'Please select class ...', 'class' => 'form-control', 'id' => 'investment_class_type_id', 'data-parsley-group'=>"block1", 'required' => 'required', 'disabled' => 'disabled']) !!}
		</div>
	</div>
