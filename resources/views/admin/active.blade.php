                ...
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- <form method="get" class="needs-validation mt-3" action="{{ url('/active')}}">
                                <div class="row">
                                    <div class="col-lg-4">
                            ...
                            <form method="get" class="needs-validation mt-3" action="{{ url('/active') }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{-- <?php $investmentTypes = [1 => 'Initial',0 => 'Additional']; ?>
                                        {!! Form::select('investment_type', $investmentTypes, null, ['placeholder' => 'Please select investment type ...', 'class' => 'form-control select2', 'id' => 'investment_type']) !!} --}}
