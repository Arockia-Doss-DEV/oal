                ...
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{ Form::open(['url' => '/contract/reports', 'id'=>'reportsForm', 'class'=>'', 'data-parsley-validate'=>'data-parsley-validate', 'autocomplete'=>"off", 'files' => true]) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    ?>
                                    {!! Form::select('status[]', $options, null, ['class' => 'form-control fund-sub-input', 'id' => 'status', 'multiple' => '', 'data-parsley-errors-container' => '#status_error', 'required'=> 'required']) !!}
