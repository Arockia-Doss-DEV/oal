...
<body>
	...
	<table>
        <tbody align="center">
            ...
            <tr><td><img src="data:image/png;base64, {{ base64_encode(@file_get_contents(public_path('logo.png'))) }}" width="150px;" height="100px"></td></tr>
        </tbody>
    </table>
		...
		<tbody>
			<tr>
				...
				<td class="font-15 "> <u class="dotted"><?= $subscription->name ?></u>
				    ...
				    {{-- <span class="helps">Please provide full legal name</span> --}}
				</td>
			</tr>
			<tr>
				...
				<td class="font-15 "><u class="dotted">{{ $subscription->address_line1 }}, {{ $subscription->address_line2 }}, {{ $subscription->city }}, {{ $subscription->post_code }}, {{ $subscription['SubscriptionStateAs']['name'] }}, {{ $subscription['SubscriptionCountryAs']['name'] }}. </u>
				    ...
				    {{-- <span class="helps">Please provide full postal address(es) of (a) in the case of an individual,
	...
	{{-- <table width="100%" class="number-table" style="padding-top: 20px;">
		<tbody>
		    <tr>
		        <td class="font-15 f-w-7">ADDITIONAL SUBSCRIPTION:</td>
			</tr>
			<tr>
		        <td class="font-15">Please provide full postal address(es) of (a) in the case of an individual, the individual's principal residence, (b) in the case of a company or other body corporate, the entity's registered office or other official address together with (if different) the entity's principal place of business, and (c) in all other cases, the Subscriber's principal place of business</td>
			</tr>
		</tbody>
	</table> --}}
	...
	<table width="100%" class="number-table">
		<tbody>
			...
			<tr>
				{{-- <td class="f-w-7" width="15%" >SUBSCRIPTION AMOUNT:</td> --}}
				<td width="30%" class="font-15 f-w-7 mr-1">SUBSCRIPTION AMOUNT:</td>
				<td class="font-15 "><u class="dotted">USD$ {{ $subscription->amount }}</u>
					<br>
					{{-- <span class="helps">Please provide the amount which the Subscriber is investing in figures</span> <br><br> --}}
					
					<u class="dotted">{{ strtoupper($currency_word) }} USD</u>

					{{-- <span class="helps">Please provide the amount which the Subscriber is investing in words</span> --}}
