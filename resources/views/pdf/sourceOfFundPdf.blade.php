...
<body>
	...
	<table width="100%" class="number-table">
		<tbody>
			@foreach ($principal_source_of_wealth as $key => $source_of_wealth)
				<tr>
	...
	<table width="100%" class="number-table">
		<tbody>
			@foreach ($principal_source_of_wealth_funds_comes as $key => $source_of_wealth)
				<tr>
					<td width="5%" class="mr-1"><input type="checkbox" checked /></td>
					<td  class="font-15">{{ $source_of_wealth }}</td>
				</tr>
	...
	<table width="100%" class="number-table">
		<tbody>
			<tr>
		        <td class="font-15"><u class="dotted"> {{ $subscription->source_of_wealth_funds_comes_other }} </u></td>
			</tr>
		</tbody>
	</table>
