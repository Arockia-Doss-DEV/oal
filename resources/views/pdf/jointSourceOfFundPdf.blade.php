...
<body>
	...
	<table width="100%" class="number-table">
		<tbody>
		    <tr>
		        ...
		        <td class="font-15"><u class="dotted"> {{ $subscription->name }} </u></td>
	...
	<table width="100%" class="number-table">
		<tbody>
			@foreach ($joint_source_of_wealth as $key => $source_of_wealth)
				<tr>
					<td width="5%" class="mr-1"><input type="checkbox" checked /></td>
					<td  class="font-15">{{ $source_of_wealth }}</td>
				</tr>
			@endforeach
		</tbody>
	</table>

	{{-- <?php if( !empty($subscription->source_of_wealth_other) &&  in_array('Other', $joint_source_of_wealth) ){ ?> 

	<table width="100%" class="number-table">
		<tbody>
			<tr>
				<td class="font-15"><u class="dotted"> {{ $subscription->source_of_wealth_other }} </u></td>
			</tr>
		</tbody>
	</table>
	...
	<table width="100%" class="number-table">
		<tbody>
			<tr>
		        <td class="font-15"><u class="dotted"> {{ $subscription->ja_source_of_wealth_other }} </u></td>
			</tr>
		</tbody>
	</table>
	...
	<table width="100%" class="number-table">
		<tbody>
			@foreach ($joint_source_of_wealth_funds_comes as $key => $source_of_wealth)
				<tr>
					<td width="5%" class="mr-1"><input type="checkbox" checked /></td>
					<td  class="font-15">{{ $source_of_wealth }}</td>
				</tr>
	...
	<table width="100%" class="number-table">
		<tbody>
			<tr>
		        <td class="font-15"><u class="dotted"> {{ $subscription->ja_source_of_wealth_funds_comes_other }} </u></td>
			</tr>
		</tbody>
	</table>
	...
	<table width="100%" class="number-table" style="padding-top: 20px;">
		...
		<tr>
			...
			@if ($subscription->UserAs->role_id == 6)
				<td width="55%" class="font-15">__________________________</td>
			@endif
