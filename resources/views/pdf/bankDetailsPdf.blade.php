...
<body>
	...
	<table width="100%" class="number-table">
		<tbody>
			...
			<tr>
				...
				<td class="font-15"><u class="dotted">{{ $subscription->address_line1 }}, {{ $subscription->address_line2 }}, </u>
					<br>
					
					<u class="dotted">{{ $subscription->city }}, {{ $subscription->post_code }},</u><br>
					<u class="dotted">{{ $subscription['SubscriptionStateAs']['name'] }}, {{ $subscription['SubscriptionCountryAs']['name'] }}</u>
	...
	{{-- <table width="100%" class="number-table" style="padding-top: 20px;">
		<tbody>
			<tr>
		        <td class="font-15">I / We hereby confirm that I / We are in complete agreement with the terms and conditions of the Fund and that we are the Authorised signatories and rightful beneficiary of the bank details update proceeds; and all information furnished herein is true and correct.</td>
			</tr>
		</tbody>
	</table>
	...
	<table width="100%" class="number-table" style="padding-top: 20px;">
		<tbody>
			<tr>
				<td width="55%" class=" font-15">This bank details update request form has been executed this  _________day of_____________________________</td>
			</tr>
		</tbody>
	</table> --}}
