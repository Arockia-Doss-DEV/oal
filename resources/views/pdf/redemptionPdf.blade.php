...
<body>
	...
	{{-- <table width="100%">
        <tr>
            <td rowspan="5" width="20%" align="center">
            	<img src="data:image/png;base64, {{ base64_encode(@file_get_contents(public_path('logo.png'))) }}" width="140px;" height="95px">
            	<td style="float: left";></td>
            	<td style="float: left";><p style="font-size:24px;">Redemption Request Form</p></td>

            	@if ($subscription->investment_class_type == '1')
				<td style="float: left";><p style="font-size: 22px; font-style: italic;">Class A Participating Shares</p></td>
				@elseif($subscription->investment_class_type == '2')
				<td style="float: left";><p style="font-size: 22px; font-style: italic;">Class B Participating Shares</p></td>
				@else
				<td style="float: left";><p style="font-size: 22px; font-style: italic;">Participating Shares</p></td>
				@endif
            </td>
            <td align="center">
	...
	<table width="100%" class="number-table">
		<tbody>
			...
			<tr>
		        {{-- <td class="font-15">The signed redemption form must be sent to the Administrator either by email or by fax and the originals to be couriered at the Administrator’s address mentioned above, 14-21 business days before the <span class="highlight">valuation day </span> which is the redemption notice period.</td> --}}
	...
	<table width="100%" class="number-table">
		<tbody>
			<tr>
				...
				<td class="font-15 "> <u class="dotted">{{ $subscription->salutation }} {{ $subscription->name }}</u>
				    {{-- <span class="help">Please provide full legal name and exact reference</span> --}}
				</td>
			</tr>
			<tr>
	...
	<table width="100%" class="number-table" style="padding-top: 20px;">
		...
		<tr>
			...
			<td> {{ $subscription->salutation }} {{ $subscription->name }} </td>
		</tr>
		<tr>
