...
<body>
    <div class="main_div">
        ...
        <table width="100%">
            <tr>
                <td rowspan="5" width="20%" align="left"><img src="data:image/png;base64, {{ base64_encode(@file_get_contents(public_path('logo.png'))) }}" width="150px;" height="100px"></td>
                <td align="left">
            		...
            		{{-- <h4>C/o Mauri Experta Ltd, 12th Level TowerI, Nexteracom Towers Cybercity,</h4>
            		<h4>Ebene Mauritius.</h4> --}}

            		<h4><strong>Email: </strong><a href="mailto:admin@olympus-asset.com"><strong>admin@olympus-asset.com</strong></a></h4>
                </td>
            </tr>
        </table>
        <img src="data:image/png;base64, {{ base64_encode(@file_get_contents(public_path('images/media/hr.png'))) }}" width="100%" height="15px">
        ...
        <?php
         ...
         {{-- <?= !empty($subscription->salutation) ? $subscription->salutation : '' ?> --}}
        ...
        <table width="100%" class="bankdetails" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td width="60%"><p>{{ config('settings.recipient_name') }}</p></td>
            </tr>
            <tr>
                <td><p>Recipient&rsquo;s Account Number :</p></td>
                <td><p>{{ config('settings.recipient_account_no') }}</p></td>
            </tr>
            <tr>
                <td><p>Recipient&rsquo;s Contact No :</p></td>
                <td><p>{{ config('settings.recipient_contact_no') }}</p></td>
            </tr>
            <tr>
                <td><p>Recipient&rsquo;s Address :</p></td>
                <td><p>{{ config('settings.recipient_address') }}</p>
                </td>
            </tr>

            <tr>
                <td><p>Beneficiary Bank :</p></td>
                <td><p>{{ config('settings.beneficiary_bank') }}</p></td>
            </tr>
            <tr>
                <td><p>Beneficiary Bank&rsquo;s SWIFT Code :</p></td>
                <td><p>{{ config('settings.beneficiary_swift_code') }}</p></td>
            </tr>
            <tr>
                <td><p>Bank Code :</p></td>
                <td><p>{{ config('settings.bank_code') }}</p></td>
            </tr>
            <tr>
                <td><p>Branch Code :</p></td>
                <td><p>{{ config('settings.branch_code') }}</p></td>
            </tr>
            <tr>
                <td><p>Beneficiary Bank&rsquo;s Address :</p></td>
                <td><p>{{ config('settings.beneficiary_bank_address') }}</p></td>
            </tr>
            <tr>
