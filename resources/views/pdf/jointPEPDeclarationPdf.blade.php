...
<body>
	...
	<table width="100%" class="number-table">
		<tbody>
			<tr>
				<td width="5%" class="font-15"><input type="checkbox" {{ ($subscription->ja_peb_declaration_status == 1) ? "checked" : ''}} /></td>
				<td  class=" font-15">No  </td>
			</tr>
			<tr>
				<td width="5%" class="font-15"><input type="checkbox" {{ ($subscription->ja_peb_declaration_status == 2) ? "checked" : ''}} /></td>
				<td class=" font-15">Yes </td>
			</tr>
		</tbody>
	</table>

	{{-- <?php if($subscription->ja_peb_declaration_status == 2){ ?> 
	...
	@elseif ($subscription->peb_declaration_status == 2)
		...
		<table width="100%" class="number-table">
			<tbody>
				...
				@foreach ($joint_origin_fund_wealth as $key => $origin_fund_wealth)
		...
		<table width="100%" class="number-table">
			<tbody>
				<tr>
					<td class="font-15"><u class="dotted"> {{ $subscription->ja_origin_fund_wealth_other }} </u></td>
				</tr>
			</tbody>
		</table>
